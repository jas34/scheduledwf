...
public class TestDefaultScheduledProcessRegistry extends TestBase {
    ...
    public void testWf_Eligibility_For_Scheduling() {
        ...
        ScheduledWorkFlow scheduledWorkFlow =
                createScheduledWorkFlow(managerInfo, ScheduledWorkFlow.State.SCHEDULING_FAILED);
        ...
        // 3. when scheduledWorkFlow is present in reference map as well as execution dao but with state
        ...
        processRegistry.updateProcessById(scheduledWorkFlow.getScheduledProcess(),
                ScheduledWorkFlow.State.RUNNING, scheduledWorkFlow.getId(), scheduledWorkFlow.getName());
    ...
    public void test_addProcess() {
        ScheduledWorkFlow scheduledWorkFlow =
                createScheduledWorkFlow(managerInfo, ScheduledWorkFlow.State.INITIALIZED);
    ...
    public void test_updateProcessById() {
        ScheduledWorkFlow scheduledWorkFlow =
                createScheduledWorkFlow(managerInfo, ScheduledWorkFlow.State.INITIALIZED);
        assertFalse(processRegistry.updateProcessById(scheduledWorkFlow.getScheduledProcess(),
                scheduledWorkFlow.getState(), scheduledWorkFlow.getId(), scheduledWorkFlow.getName()));

        processRegistry.addProcess(scheduledWorkFlow);
        assertTrue(processRegistry.updateProcessById(scheduledWorkFlow.getScheduledProcess(),
                scheduledWorkFlow.getState(), scheduledWorkFlow.getId(), scheduledWorkFlow.getName()));
    }
    ...
    public void test_getTobeShutDownProcesses() {
        ScheduledWorkFlow scheduledWorkFlow1 =
                createScheduledWorkFlow(managerInfo, TEST_WF_NAME + "-1", ScheduledWorkFlow.State.RUNNING);
        ...
        List<ScheduledWorkFlow> tobeShutDownProcesses =
                processRegistry.getTobeShutDownProcesses(managerInfo.getId(),
                        Arrays.asList(scheduledWorkFlow1.getName(), scheduledWorkFlow2.getName()));
